...
public class LunarHandler {
    ...
    public LunarHandler(Calendar cal) {
    ...
    public LunarData lunar() {
        LunarData lunarData = new LunarData();
        lunarData.setZodiac(animalsYear());
        lunarData.setGanzhi(cyclical());
        lunarData.setYear(Integer.toString(year));
        lunarData.setMonth(chineseNumber[month - 1]);
        lunarData.setDay(getChinaDayString(day));
        return lunarData;
    }
}